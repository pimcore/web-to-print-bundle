    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('chromiumHostUrl')
                    ->setDeprecated('pimcore/web-to-print-bundle', '1.5', 'The node "%node%" is deprecated and will me removed in the next major version')
                ->end()
                ->scalarNode('chromiumSettings')
                    ->setDeprecated('pimcore/web-to-print-bundle', '1.5', 'The node "%node%" is deprecated and will me removed in the next major version')
                ->end()
